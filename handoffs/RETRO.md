...
| --- | --- | --- | --- |
| R0-1 | Scripts are tested on the authoring machine only. Verify `install-kiro.ps1 -Check`, `check-redaction.ps1`, and `distill-fixture.ps1` at work; log any execution-policy or encoding failure here. | S0 | OPEN |
